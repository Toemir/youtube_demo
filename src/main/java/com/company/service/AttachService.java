...
public class AttachService {
    ...
    public AttachService(AttachRepository attachRepository, ProfileService profileService, ChannelService channelService) {
    ...
    public String getUrl(String photoId) {
        return serverUrl+"/api/v1/attach/"+photoId;
    }
